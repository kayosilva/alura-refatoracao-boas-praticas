...
class Crawler
{
     ...
     * @return ResultList
     */
    public function getResults(SearchTermInterface $searchTerm,
                               string              $googleDomain = 'google.com',
                               string              $countryCode = ''): ResultList
    {
        ...
        $googleUrl      = $this->getGoogleUrl($googleDomain, $searchTerm, $countryCode);
...
//        $googleResultList = $domCrawler->filterXPath('//div[@class="ZINbbc xpd O9g5cc uUPGi"]');
     ...
     * @return string
     */
    private function getGoogleUrl(string $domain, string $searchTerm, string $countryCode): string
    {
